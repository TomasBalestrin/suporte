...
# L010 — Vercel não auto-deploya o projeto Fluxon; deploy é manual via CLI
...
- Não confundir com o **FluxonApp** (projeto `fluxonapp`, repo separado) — esse usa Vercel também mas com auto-deploy funcionando normalmente. Workaround só vale pro projeto **Fluxon/Disparotey**.
