---
name: the-boys-playbook-registrar-nova-licao-f20
description: P003 — Registrar nova lição F20 (Memória Autônoma). Quando: Você (persona ou usuário) detectou um padrão de erro pela **3ª vez** na mesma sessão ou em tarefas similares. Threshold mais cedo (1ª ou 2ª) só se o impacto for grave demais pra...
---
