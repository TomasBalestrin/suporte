---
name: the-boys-playbook-setup-obsidian-no-vault-de-projeto
description: P001 — Setup Obsidian num vault de projeto. Quando: Você abriu um projeto/repo no Obsidian pela 1ª vez (vault = repo) e o file explorer/graph está poluído com `node_modules`, `dist`, `build`, etc. Precisa configurar pra ficar uti...
---
