-- ============================================
-- REPAIR SCRIPT - Run this if migration 001 failed
...
CREATE INDEX IF NOT EXISTS idx_tickets_agent ON public.tickets(assigned_agent_id);
CREATE INDEX IF NOT EXISTS idx_tickets_code ON public.tickets(ticket_code);
CREATE INDEX IF NOT EXISTS idx_tickets_access_token ON public.tickets(access_token);
...
CREATE INDEX IF NOT EXISTS idx_activity_log_ticket ON public.activity_log(ticket_id);
...
DROP TRIGGER IF EXISTS set_access_token ON public.tickets;
...
DROP TRIGGER IF EXISTS set_sla ON public.tickets;
...
-- ============================================
-- ROW LEVEL SECURITY (drop + recreate policies)
-- ============================================
...
DO $$ BEGIN
  ...
  -- Tags
  DROP POLICY IF EXISTS "Agents can read tags" ON public.tags;
  DROP POLICY IF EXISTS "Admins can manage tags" ON public.tags;
  -- Customers
  DROP POLICY IF EXISTS "Agents can read customers" ON public.customers;
  DROP POLICY IF EXISTS "Anyone can insert customers" ON public.customers;
  DROP POLICY IF EXISTS "Agents can update customers" ON public.customers;
  -- Tickets
  DROP POLICY IF EXISTS "Agents can read all tickets" ON public.tickets;
  ...
  -- Ticket Tags
  DROP POLICY IF EXISTS "Agents can read ticket tags" ON public.ticket_tags;
  DROP POLICY IF EXISTS "Agents can manage ticket tags" ON public.ticket_tags;
  -- Quick Replies
  DROP POLICY IF EXISTS "Agents can read quick replies" ON public.quick_replies;
  DROP POLICY IF EXISTS "Admins can manage quick replies" ON public.quick_replies;
  -- Knowledge Base
  DROP POLICY IF EXISTS "Anyone can read active articles" ON public.knowledge_base;
  DROP POLICY IF EXISTS "Admins can manage knowledge base" ON public.knowledge_base;
  -- AI Config
  DROP POLICY IF EXISTS "Agents can read ai config" ON public.ai_config;
  DROP POLICY IF EXISTS "Admins can manage ai config" ON public.ai_config;
  -- AI Unanswered
  DROP POLICY IF EXISTS "Agents can read unanswered" ON public.ai_unanswered_questions;
  DROP POLICY IF EXISTS "Anyone can insert unanswered" ON public.ai_unanswered_questions;
  DROP POLICY IF EXISTS "Admins can update unanswered" ON public.ai_unanswered_questions;
  -- AI Feedback
  DROP POLICY IF EXISTS "Agents can read feedback" ON public.ai_feedback;
  DROP POLICY IF EXISTS "Anyone can insert feedback" ON public.ai_feedback;
  -- SLA
  DROP POLICY IF EXISTS "Agents can read sla" ON public.sla_configs;
  DROP POLICY IF EXISTS "Admins can manage sla" ON public.sla_configs;
  -- Automations
  DROP POLICY IF EXISTS "Admins can manage automations" ON public.automation_rules;
  -- Notifications
  DROP POLICY IF EXISTS "Agents can read notifications" ON public.notification_log;
  DROP POLICY IF EXISTS "System can insert notifications" ON public.notification_log;
  -- Activity
  DROP POLICY IF EXISTS "Agents can read activity" ON public.activity_log;
...
-- ============================================
-- SEED DATA (ON CONFLICT = safe to re-run)
-- ============================================
